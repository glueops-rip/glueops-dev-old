...
To enable GlueOps access to your GitHub organization, you will need to provide the following values, which is required for deploying the [terraform-module-cloud-multy-prerequisites](https://github.com/GlueOps/terraform-module-cloud-multy-prerequisites) module.
