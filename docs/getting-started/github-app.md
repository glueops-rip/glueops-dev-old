...
The GitHub App is used by the Platform to access Tenant GitHub Organizations to provide the following services:
...
1. Go to the Developers settings page on the the Tenant's Github Organization page.
